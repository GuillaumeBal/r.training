...
## --------------------------------------
## 1.1.2 Variable declaration/assignment:
myVar <- 1
print(myVar)
...
## --------------------------------
## 1.1.4 Getting help on functions:
?rep
?mode
...
## -----------------------------------
## 1.2 Types and arrangements of data:
## 1.2.1 Types:
...
## ---------------------------------------
## 1.5.2 Tests among elements of a vector:
...
## ---------------------------------------
## 1.5.3 Long - not vectorised - versions:
...
c("1916-04-24", "1994-04-05", "2016-03-10") >= Sys.Date()  # ... which works both ways O_o

## ------------------------------------
## 1.6.2 Testing for indefinite values:
...
## -----------------------------------------------------------------------
## 1.9 Mind the precedence of operators (always use brackets if not sure):
